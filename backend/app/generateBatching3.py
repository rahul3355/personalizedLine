...
BATCH_PROMPT_RULES = (
    ...
    "- VARY the sentence structure for each company to avoid sounding formulaic. Use a mix of:\n"
    "  a) Starting with the recipient's role: 'As a [Title] at [Company]...'\n"
    "  b) Starting with the industry/context: 'Scaling in the [Industry] space often means...'\n"
    "  c) Starting with the company name: '[Company]'s focus on [X]...'\n"
    "  d) Weaving the company name naturally into the middle of the sentence.\n"
