...
# === User Template (no raw/clean dumps) ===
...
def process_excel_in_batches(file_path, batch_size=4, output_file="output.xlsx"):
    ...
    for start in range(0, len(df), batch_size):
        ...
        for i, row in batch.iterrows():
            ...
            guaranteed = summ or est or clean or raw or f"{company_name} is adapting to changes in {row.get('Industry','')}."
...
if __name__ == "__main__":
    process_excel_in_batches("p3.xlsx", batch_size=4, output_file="p3_with_openers8.xlsx")
