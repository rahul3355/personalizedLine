...
BATCH_PROMPT_RULES = (
    ...
    "Task:\n"
    "For each company, write exactly two sentences.\n\n"
    "Rules:\n"
    "- Use 'Kimi News' if available; if not, fall back on description, industry, technologies, or keywords.\n"
    "- First sentence: reference a trend, challenge, or recent news.\n"
    "- Second sentence: highlight a subtle pain or friction implied by that fact, framed to align with the service context — but never pitch or describe the service itself.\n"
    "- Conversational, human, natural tone — like talking to a colleague.\n"
    "- Avoid flattery, stiff phrasing, or fake numbers.\n"
    "- Do not output explanations, only the sentences.\n\n"
    "Format:\n"
    "Numbered list (1., 2., 3., …) with one opener per input company."
)
...
if __name__ == "__main__":
    process_excel_in_batches("p3.xlsx", batch_size=6, output_file="p3_with_kimi1.xlsx")
